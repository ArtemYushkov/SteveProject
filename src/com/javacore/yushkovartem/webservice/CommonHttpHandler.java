...
public class CommonHttpHandler implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        if (path.matches(HTML_FORMAT)) {
            result = htmlHandle(httpExchange);

        } else if (path.matches(CSS_FORMAT)) {
            result = cssHandle(httpExchange);

        } else if (path.matches(SCBID_FORMAT)){
            result = myHandle(httpExchange);
    ...
    private String htmlHandle(HttpExchange httpExchange){
        String path = httpExchange.getRequestURI().getPath();
    ...
    private String cssHandle(HttpExchange httpExchange){
        String path = httpExchange.getRequestURI().getPath();
    ...
    private String myHandle(HttpExchange httpExchange){
        String path = httpExchange.getRequestURI().getPath();
